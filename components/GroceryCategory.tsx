...
const GroceryCategory = () => {
    ...
    useEffect(() => {
        const getHistoryData = async () => {
            const historyData = await axios.post('http://10.0.2.2:5000/history/getByType', {type: 'Grocery'});
                    ...
                    <View style={{flex: 1}}>
                        <FlatList
                            ...
                            renderItem={({item, index}) => (
                                <Card key={index} style={{alignItems: 'center', marginBottom: 10, flex: 1, marginRight: width * 0.0083, marginLeft: width * 0.0083,}}>
